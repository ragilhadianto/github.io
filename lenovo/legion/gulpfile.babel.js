...
const DEV_PATH = {
  ...
  script: {
    vendor: {
      order: [
        `${SRC}/scripts/vendors/gsap.min.js`,
        `${SRC}/scripts/vendors/jquery-3.6.0.min.js`,
        `${SRC}/scripts/vendors/imagesLoaded.min.js`,
        `${SRC}/scripts/vendors/owl.carousel.min.js`,
        `${SRC}/scripts/vendors/ScrollMagic.min.js`,
        `${SRC}/scripts/vendors/animation.gsap.js`,
        `${SRC}/scripts/vendors/debug.addIndicators.min.js`,
...
const BUILD_PATH = {
  ...
  others: {
    forbidden: [
      ...
      `${BUILD}/assets/video`,
      `${BUILD}/assets/images`,
      `${BUILD}/assets/images/bg`,
      `${BUILD}/assets/images/dummy`,
      `${BUILD}/assets/images/homescreen`,
      `${BUILD}/assets/images/icons`,
      `${BUILD}/assets/images/logo`,
      `${BUILD}/assets/js`,
...
export const copyVideos = () => {
  return src(DEV_PATH.videos)
    ...
    .on("end", () => {
      console.log(
        c[COLORS.success].bold("--------- Videos finished copying! ---------")
      );
    });
};
...
export const devWatch = (done) => {
  ...
  // Videos
  // watch(DEV_PATH.fonts, copyVideos);
